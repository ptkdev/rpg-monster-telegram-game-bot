 ...
 * =====================
 *
 * RPG Monster Game Bot for Telegram Groups
 *
 ...
 *
 *
 * @interface [QuestionInterface](https://github.com/ptkdev/rpg-monster-telegram-game-bot/blob/main/app/webcomponent/types/databases.interfaces.ts)
 *
...
export interface QuestionsInterface {
	 ...
	 * =====================
	 *
	 * @interface [QuestionsInterface](https://github.com/ptkdev/rpg-monster-telegram-game-bot/blob/main/app/webcomponent/types/databases.interfaces.ts)
	 *
	 * @param { string } user_id - user id from telegram
	 *
	 */
	 ...
	 * =====================
	 *
	 * @interface [QuestionsUserInterface](https://github.com/ptkdev/rpg-monster-telegram-game-bot/blob/main/app/webcomponent/types/databases.interfaces.ts)
	 *
