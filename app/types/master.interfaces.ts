 ...
 *
 *
 * @interface [MasterUserInterface](https://github.com/ptkdev/rpg-monster-telegram-game-bot/blob/main/app/webcomponent/types/databases.interfaces.ts)
 *
...
export interface MasterInterface {
	 ...
	 * =====================
	 *
	 * @interface [MasterInterface](https://github.com/ptkdev/rpg-monster-telegram-game-bot/blob/main/app/webcomponent/types/databases.interfaces.ts)
	 *
